...
which represents an api_out_input run containing multiple or one point(s).
"""


from django.db import models
from source.webapp.simulation_configuration.models.simulation_point_model import SimulationPointModel


class SimulationRunModel(models.Model):
    """
    This class represents an api_out_input run containing multiple or one point(s).
    This class is used to identify the location, where the result of run is stored to complete the api_out_input.
    """
    ...
    def get_path(self) -> str:
        ...
        The path is the location where the result of the run is stored to complete the api_out_input.
